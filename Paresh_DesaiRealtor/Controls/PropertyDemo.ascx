 ...
 <script>
     ...
     $(document).ready(function () {
         $("#shareBtn").click(function () {
             ...
             var URL = 'http://sureshsharmarealty.com//PropertyDetails.aspx?MLSID=' + MLSID + '&PropertyType=' + PropertyType;
            ...
            <div class="col-md-12 col-sm-12">
              ...
              <img src="../images/arshad.png" alt="" />
                        ...
                        <div class="roco_pro_info">
                            <h2>
                                <asp:Label ID="lblname" runat="server"></asp:Label>Suresh Sharma & Pradeep Chadha</h2>
                            <p>Sales Representative</p>
                              <span class="email_profile_r">647-309-7000, 416-312-6172</span>
