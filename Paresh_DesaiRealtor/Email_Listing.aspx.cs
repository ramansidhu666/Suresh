    ...
    public partial class Email_Listing : System.Web.UI.Page
    {
        ...
        public string GetPropertyDetails()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                html.AppendLine("<h2 style='font-weight:bold; font-size:16px;'>Suresh Sharma & Pradeep Chadha for Property ID  " + dt.Rows[0]["MLS"].ToString() + ";</h2>");
                html.AppendLine("<h2 style='font-weight: bold; font-size: 16px;'>Message Received From:</h2>");
                html.AppendLine("<p style='float: left; margin: 0 40px 0 0;'>Phone Number:</p><span style='float:left;'>647-309-7000 , 416-312-6172</span><br/>");
                ...
                html.AppendLine("<p>http://sureshsharmarealty.com///</p>");
                ...
                //html.AppendLine("1098 Peter Robertson Blvd #25 Brampton, Ontario, L6R3A5<br/>Property ID: " + dt.Rows[0]["MLS"].ToString() + "</h2>");
                html.AppendLine("</div>");
                ...
                html.AppendLine("<p>For more information visit <a href='#'>http://sureshsharmarealty.com//</a> </p></div>");
                html.AppendLine("<div style='float:left; padding-left:12px;'>");
                html.AppendLine("<p style='margin:0px;'>Listed By</p><br/><p>Suresh Sharma & Pradeep Chadha<br/>Sales Representative</p>");
                ...
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>Cell::</p><span style='float:left;'>647-309-7000 , 416-312-6172</span><br/>'");
                ...
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>Website:</p><span style='float:left;'>>http://sureshsharmarealty.com///</span><br/></div></div>");
                html.AppendLine("<div style='float:left; width:100%;'>");
